...
test('there is no default network target, URL override, or implicit live approval', () => {
  ...
  assert.deepEqual(parseInvocation(['--rehearsal-worktree']), { live: false, origin: REHEARSAL_ORIGIN, receiptPath: undefined, worktreeRehearsal: true });
  assert.throws(() => parseInvocation(['--rehearsal-worktree', LIVE_ORIGIN]));
});
